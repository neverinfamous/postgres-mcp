...
- **Vector Tools**: Certified the 16-tool `vector` group via the advanced strict coverage testing matrix, verifying split schema validation, P154 object existence handling, dimension constraints, and parameter alias compatibility without exposing raw MCP errors.

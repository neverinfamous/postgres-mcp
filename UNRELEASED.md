...
- **Admin Tools**: Certified the 11-tool `admin` group via the advanced strict coverage testing matrix, verifying split schema validation, P154 object existence handling, parametric constraints, and idempotency across boundary conditions without exposing raw MCP errors.

...
Write-Info "partman_*, prompt_*, mcp_*, orders_*, ltree_*, fts_*, spatial_places*, jsonb_*, notebook_*, e2e_*, empty_*, batch_*, verify_*, audit_test_*, smoke_*, etc."

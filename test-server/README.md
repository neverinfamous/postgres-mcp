...
| `test-tool-groups/*.md`                      | ~24 KB ea   | Per-group **deterministic checklists** for all 23 tool groups. Each section has numbered items with exact inputs/outputs, 🔴 error path items, alias tests, and create→use→drop lifecycles.                 | When running a specific tool group                                                                 |
...
| `tool-groups-list.md`                        | 8 KB        | **Canonical tool inventory** — all 23 groups, 257 tools. Source of truth for tool counts.                                                                                                                   | Reference / auditing                                                                               |
| `tool-reference.md`                          | 31 KB       | **Complete Tool Reference** — Detailed list of all 257 tools mapped to their specific tool groups.                                                                                                          | Reference                                                                                          |
...
## Tool Groups (23 groups, 257 tools)
...
7. (Optional) Run stress tests sequentially from `test-advanced/test-tools-advanced-[1-4].md`.

...
| `test-tool-groups/*.md`                      | ~24 KB ea   | Per-group **deterministic checklists** for all 24 tool groups. Each section has numbered items with exact inputs/outputs, 🔴 error path items, alias tests, and create→use→drop lifecycles.                 | When running a specific tool group                                                                 |
...
| `tool-reference.md`                          | 31 KB       | **Complete Tool Reference** — Detailed list of all 269 tools mapped to their specific tool groups.                                                                                                          | Reference                                                                                          |
...
## Tool Groups (24 groups, 269 tools)

...
- **Temporary tables/schemas/views**: Prefix with `stress_stats_`
- **Cleanup**: Attempt to remove all `stress_stats_*` objects after testing.
...
1. Confirm cleanup of all `stress_stats_*` objects.

  ...
  return {
    ...
    handler: async (params: unknown, _context: RequestContext) => {
      try {
        ...
        throw parsePostgresError(error, { tool: "pg_explain" });
      }
    },
  };
}
  ...
  return {
    ...
    handler: async (params: unknown, _context: RequestContext) => {
      try {
        ...
        throw parsePostgresError(error, { tool: "pg_explain_analyze" });
      }
    },
  };
}
  ...
  return {
    ...
    handler: async (params: unknown, _context: RequestContext) => {
      try {
        ...
        throw parsePostgresError(error, { tool: "pg_explain_buffers" });
      }
    },
  };
}

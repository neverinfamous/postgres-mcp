...
export const ReadQueryOutputSchema = z
  .object({
    ...
    executionTimeMs: z
      .number()
      .optional()
      .describe("Query execution time in ms"),
...
export const WriteQueryOutputSchema = z
  .object({
    ...
    insertedCount: z
      .number()
      .optional()
      .describe("Number of rows inserted (batch/bulk)"),
...
const TableInfoSchema = z.object({
  ...
  totalSizeBytes: z
    .number()
    .optional()
    .describe("Total size including indexes"),
  comment: z.string().nullable().optional().describe("Table comment"),
  statsStale: z
    .boolean()
    .optional()
    .describe("Whether pg_class stats are stale"),
});

// Output schema for pg_list_tables
export const TableListOutputSchema = z
  .object({
...
export const TableDescribeOutputSchema = z
  .object({
    success: z.boolean().optional().describe("Whether the operation succeeded"),
...
export const TableOperationOutputSchema = z
  .object({
    success: z.boolean().optional().describe("Whether the operation succeeded"),
    ...
    existed: z
      .boolean()
      .optional()
      .describe("Whether table existed before drop"),
    sql: z.string().optional().describe("Generated SQL statement"),
...
export const TruncateOutputSchema = z
  .object({
...
export const IndexListOutputSchema = z
  .object({
    success: z.boolean().optional().describe("Whether the operation succeeded"),
...
export const IndexOperationOutputSchema = z
  .object({
    success: z.boolean().optional().describe("Whether the operation succeeded"),
...
export const ObjectListOutputSchema = z
  .object({
    success: z.boolean().optional().describe("Whether the operation succeeded"),
    objects: z
...
export const ObjectDetailsOutputSchema = z
  .object({
    success: z.boolean().optional().describe("Whether the operation succeeded"),
...
export const ExtensionListOutputSchema = z
  .object({
    extensions: z
      .array(ExtensionInfoSchema)
      .optional()
...
export const HealthAnalysisOutputSchema = z
  .object({
...
export const IndexRecommendationsOutputSchema = z
  .object({
    ...
    queriesAnalyzed: z
      .number()
      .optional()
      .describe("Number of queries analyzed"),
    hint: z.string().optional().describe("Additional information"),
  })
  .extend(ErrorResponseFields.shape);

// Output schema for pg_analyze_query_indexes
export const QueryIndexAnalysisOutputSchema = z
  .object({

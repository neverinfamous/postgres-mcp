...
export const JsonbStatsSchemaBase = z.object({
  ...
  sampleSize: z
    .union([z.number(), z.string()])
    .optional()
    .describe("Sample rows to analyze"),
...
export const JsonbExtractOutputSchema = z
  .object({
    rows: z
...
export const JsonbSetOutputSchema = z
  .object({
...
export const JsonbInsertOutputSchema = z
  .object({
    rowsAffected: z.number().optional().describe("Number of rows updated"),
    success: z.boolean().optional().describe("False on error"),
    error: z.string().optional().describe("Error message"),
...
export const JsonbDeleteOutputSchema = z
  .object({
    rowsAffected: z.number().optional().describe("Number of rows updated"),
...
export const JsonbContainsOutputSchema = z
  .object({
    rows: z
      .array(z.record(z.string(), z.unknown()))
      .optional()
...
export const JsonbPathQueryOutputSchema = z
  .object({
...
export const JsonbAggOutputSchema = z
  .object({
    result: z
      .unknown()
      .optional()
...
export const JsonbObjectOutputSchema = z
  .object({
    object: z
...
export const JsonbArrayOutputSchema = z
  .object({
...
export const JsonbKeysOutputSchema = z
  .object({
    keys: z
      .array(z.string())
      .optional()
...
export const JsonbTypeofOutputSchema = z
  .object({
    types: z
...
export const JsonbValidatePathOutputSchema = z
  .object({
...
export const JsonbMergeOutputSchema = z
  .object({
...
export const JsonbNormalizeOutputSchema = z
  .object({
    rows: z
      .array(z.record(z.string(), z.unknown()))
      .optional()
...
export const JsonbDiffOutputSchema = z
  .object({
    differences: z
      .array(
        z.object({
...
export const JsonbIndexSuggestOutputSchema = z
  .object({
    recommendations: z
      .array(z.string())
      .optional()
...
export const JsonbSecurityScanOutputSchema = z
  .object({
    issues: z
      .array(
        z.object({
...
export const JsonbStatsOutputSchema = z
  .object({
    basics: z
      .object({

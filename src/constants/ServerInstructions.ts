/**
 * Server instructions for postgres-mcp.
 *
...
/**
 * Instruction sections keyed by group name.
...
export function generateInstructions(
  ...
  let instructions = '';
  for (const [group, content] of INSTRUCTION_SECTIONS) {
...
/**
 * Static instructions (all sections, unfiltered)
 * @deprecated Use generateInstructions() for filtered content
 */
export const SERVER_INSTRUCTIONS = (() => {
  let all = '';
  for (const content of INSTRUCTION_SECTIONS.values()) {
    all += content;
  }
  return all;
})();

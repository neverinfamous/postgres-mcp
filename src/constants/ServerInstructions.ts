...
- \`pg_dependency_graph\`: FK dependency graph with cycle detection, row counts, edge annotations (CASCADE, RESTRICT, SET NULL, SET DEFAULT, NO ACTION). Params: \`schema?\`, \`excludeExtensionSchemas?\` (default: true, excludes cron/topology/tiger/tiger_data)
